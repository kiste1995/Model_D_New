...
from zetabank_msgs.srv import TurnSrv, TurnQuaternionSrv
# from zetabot_main.srv import TurnSrv, TurnQuaternionSrv

a_val = 0.3
robot_z = 0
Kp = 0.4
MATH_DEG2RAD = 0.0174532

pose = Pose()


cmd_vel_pub = rospy.Publisher('/cmd_vel', Twist, queue_size=10)
angle_pub = rospy.Publisher('/heading_angle',Int16,queue_size=10)
...
def turn(comm) :
    ...
    while abs(goal_direction-robot_z)>=3 and rotation_flag != 0 :
        ...
        twist.angular.z = Kp * (relative_angle)*MATH_DEG2RAD
