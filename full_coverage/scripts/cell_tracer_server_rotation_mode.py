...
boundary_rotation.data = [0,width_boundary + 0.25]
...
# def go2back (back_distance,back = 1) :
#     global pose
#     global twist
#     global x_val
#     global warning_msg
...
def coner_coverage(location,direction,x_pre,y_pre):
    ...
    #         front_wall = True
    #         side_wall_distance = go2wall()
    #         go2back(side_wall_distance,-1)

    #     else :
    #         side_wall = side_wall_check(location.wall,location.direction)
    #         trun(side_wall,direction,90)
    #         side_wall_distance = go2wall()
    #         go2back(side_wall_distance,-1)
    #         trun("left",direction)
    #         # side_wall = side_wall_check(location.wall,location.direction)
